    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('New Student') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="/create-new-student" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('subject')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="email" placeholder="Student Email" name="email">
                                        @error('email')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="student-password" class="form-control-label">{{ __('Password') }}</label>
                                <div class="@error('student.password')border border-danger rounded-3 @enderror">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'Create New Student' }}</button>
                    </div>
                </form>
